...
static CGFloat const CRNavigationBarDefaultHeightiPhoneLandscape = 45.0f;//Prasanna 33.0f;
...
+ (void)initialize {
    if (self == [CRToast class]) {
        ...
        kCRFontDefault = [UIFont systemFontOfSize:13];
        kCRTextColorDefault = [UIColor whiteColor];
        kCRTextShadowOffsetDefault = CGSizeZero;
        kCRSubtitleFontDefault = [UIFont systemFontOfSize:13];
        kCRSubtitleTextColorDefault = [UIColor whiteColor];
        kCRSubtitleTextShadowOffsetDefault = CGSizeZero;
        kCRBackgroundColorDefault = [[UIApplication sharedApplication] delegate].window.tintColor ?: [UIColor darkGrayColor];
