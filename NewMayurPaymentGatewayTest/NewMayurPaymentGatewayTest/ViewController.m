...
-(void)setPaymentParamAndStartProcess{
    ...
    [obj getPayUHashesWithPaymentParam:self.paymentParam merchantSalt:@"eCwWELxi" withCompletionBlock:^(PayUModelHashes *allHashes, PayUModelHashes *hashString, NSString *errorMessage) {
